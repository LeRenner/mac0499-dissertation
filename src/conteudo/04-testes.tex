...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{packet-tor.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{packet-local.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{packet-plaintext.png}
